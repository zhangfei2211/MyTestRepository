...
namespace Utlis
{
    public class DESHelp
    {
        ...
        public static string DESEncrypt(string encryptString, string encryptKey="12345678")
        {
            try
            {
        ...
        public static string DESDecrypt(string decryptString, string decryptKey = "12345678")
        {
            try
            {
