...
namespace Dal
{
    public class BaseRepository<T> : IBaseRepository<T> where T : class
    {
        ...
        public virtual async Task<bool> Add(T entity, bool isSaveChange = true)
        {
            try
            {
                db.Entry<T>(entity).State = EntityState.Added;

                return await SaveChanges(isSaveChange);
            }
            catch (Exception)
            {
                return false;
        ...
        public virtual async Task<bool> Adds(List<T> list, bool isSaveChange = true)
        {
        ...
        public virtual async Task<bool> Update(T entity, bool isSaveChange = true)
        {
        ...
        public virtual async Task<bool> Updates(List<T> list, bool isSaveChange = true)
        {
            foreach (T ele in list)
            {
                db.Set<T>().Attach(ele);
        ...
        public virtual async Task<bool> AddOrUpdate(T entity, bool isSaveChange = true)
        {
            return true;
        }

        public virtual async Task<bool> Delete(T entity, bool isSaveChange = true)
        {
        ...
        public virtual async Task<bool> Deletes(List<T> list, bool isSaveChange = true)
        {
            foreach (T ele in list)
            {
        ...
        public virtual async Task<bool> DeletePhysicalData(T entity, bool isSaveChange = true)
        {
            db.Set<T>().Attach(entity);
        ...
        public virtual async Task<bool> DeletePhysicalDatas(List<T> list, bool isSaveChange = true)
        {
            foreach (T ele in list)
            {
                db.Set<T>().Attach(ele);
        ...
        private async Task<bool> SaveChanges(bool isSaveChange)
        {
            if (isSaveChange)
            {
